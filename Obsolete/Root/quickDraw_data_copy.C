...
void quickDraw_Data( string period = "data15-16" , string channel  = "ee" , string var = "met" , bool VgSubtracted = false , string smearing_mode = "NoSmear" , bool normalize = true ) {
  ...
  // for v1.2
  string outPath = "../Outputs/OutputNtuples_v1.2/";

  string VgString = "";
  if( VgSubtracted ) VgString = "_VgSubtracted";
  
  string Zfilename      = outPath + "ZMC16a/Zjets_merged_processed.root";
  ...
  string gfilename      = outPath + "gdata/" + period + VgString + "_" + smearing_mode + ".root";
