namespace cuts {
    ...
    unordered_map<string, TCut> plot_regions = {
        ...
        {"SRC", "nLep_signal==2 && nJet30>=2 && mt2leplsp_0>90 && (Ptll>40 && Ptll<100) && MET_sig>10 && mll<50"},
        {"SRCZ", "nLep_signal==2 && nJet30>=4 && mt2leplsp_0>90 && (Ptll>40 && Ptll<100) && MET_sig>10 && (mll>81 && mll<101)"},
        {"SRLow4", "nLep_signal==2 && nJet30>=4 && HT>250 && mt2leplsp_0>100 && (Ptll>40 && Ptll<500) && (mll<150 && !(mll>81 && mll<101))"},
        {"SRLowZ", "nLep_signal==2 && nJet30>=6 && HT>250 && mt2leplsp_0>100 && (Ptll>40 && Ptll<500) && (mll>81 && mll<101)"},
        {"SRMed4", "nLep_signal==2 && nJet30>=4 && HT>500 && mt2leplsp_0>75 && (Ptll>40 && Ptll<800) && (mll>100 && mll<550)"},
        {"SRMedZ", "nLep_signal==2 && nJet30>=6 && HT>500 && mt2leplsp_0>75 && (Ptll>40 && Ptll<800) && (mll>81 && mll<101)"},
        {"SRHigh4", "nLep_signal==2 && nJet30>=4 && HT>800 && mt2leplsp_0>75 && Ptll>40 && (mll>150 && mll<950)"},
        {"SRHighZ", "nLep_signal==2 && nJet30>=6 && HT>800 && mt2leplsp_0>75 && Ptll>40 && (mll>81 && mll<101)"},

        {"VRC", "nLep_signal==2 && nJet30>=2 && mt2leplsp_0>90 && (Ptll>40 && Ptll<100) && MET_sig>10 && mll<50"},
        {"VRCZ", "nLep_signal==2 && nJet30>=4 && mt2leplsp_0>90 && (Ptll>40 && Ptll<100) && MET_sig>10 && (mll>81 && mll<101)"},
        {"VRLow4", "nLep_signal==2 && nJet30>=4 && HT>250 && mt2leplsp_0>100 && (Ptll>40 && Ptll<500) && (mll<150 && !(mll>81 && mll<101))"},
        {"VRLowZ", "nLep_signal==2 && nJet30>=6 && HT>250 && mt2leplsp_0>100 && (Ptll>40 && Ptll<500) && (mll>81 && mll<101)"},
        {"VRMed4", "nLep_signal==2 && nJet30>=4 && HT>500 && mt2leplsp_0>75 && (Ptll>40 && Ptll<800) && (mll>100 && mll<550)"},
        {"VRMedZ", "nLep_signal==2 && nJet30>=6 && HT>500 && mt2leplsp_0>75 && (Ptll>40 && Ptll<800) && (mll>81 && mll<101)"},
        {"VRHigh4", "nLep_signal==2 && nJet30>=4 && HT>800 && mt2leplsp_0>75 && Ptll>40 && (mll>150 && mll<950)"},
        {"VRHighZ", "nLep_signal==2 && nJet30>=6 && HT>800 && mt2leplsp_0>75 && Ptll>40 && (mll>81 && mll<101)"},
    };
