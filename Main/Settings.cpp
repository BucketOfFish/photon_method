...
namespace cuts {
    ...
    std::unordered_map<std::string, TCut> selections = {
        ...
        {"SRLow", "(trigMatch_2LTrigOR && nJet30 >= 1 && lepPt[1] > 25. && nLep_signal == 2 && nLep_base == 2 && lepCharge[0] != lepCharge[1] && met_Sign > 6. && 12. < mll && mll < 150. && lepFlavor[0] == lepFlavor[1] && nBJet20_MV2c10_FixedCutBEff_77 == 0 && 81. < mll && mll < 101. && 6. < met_Sign && met_Sign < 12. && met_Et > 100. && mt2leplsp_0 > 80. && nJet30 == 2 && 60. < mjj && mjj < 110. && Rll < 1."},
